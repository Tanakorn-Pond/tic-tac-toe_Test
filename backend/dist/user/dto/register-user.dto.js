...
__decorate([
    (0, class_validator_1.IsString)({ message: 'ยืนยันรหัสผ่านต้องเป็นข้อความ' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'กรุณากรอกยืนยันรหัสผ่าน' }),
    (0, class_validator_1.MinLength)(6, { message: 'ยืนยันรหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร' }),
    (0, class_validator_1.MaxLength)(100, { message: 'ยืนยันรหัสผ่านต้องไม่เกิน 100 ตัวอักษร' }),
    __metadata("design:type", String)
