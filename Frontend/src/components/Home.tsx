  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_10%_20%,rgba(14,165,233,0.15),transparent_32%),radial-gradient(circle_at_90%_85%,rgba(34,197,94,0.15),transparent_34%),linear-gradient(130deg,#0f172a_0%,#1e293b_100%)] px-6 py-8">
      ...
      <section className="mx-auto w-full max-w-5xl mt-5">
        <div className="flex flex-col gap-4 rounded-3xl border border-slate-700/50 bg-slate-900/80 p-7 shadow-[0_20px_45px_rgba(0,0,0,0.2)] backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
          <button
            onClick={() => navigate("/bot-room")}
            className="border border-slate-500/50 bg-slate-700/50 p-3 rounded-xl text-white sm:text-xl"
          >
            Room-bot
          </button>
        </div>
